        ...
        if event.key == "enter":
            ...
            if text:
                if text.lower() == "exit":
                    ...
                    await self.fancy_print(f"[bold cyan]You: [/bold cyan]{text}")
                    self.input_widget.clear()
                    self.input_widget.focus()
        ...
        while True:
            ...
            if choice:
                ...
                if choice.lower() == "exit":
                    ...
                    await self.fancy_print("\n[cyan]System: [/cyan] It is a [cyan]Yes[/cyan] or [red]No[/red] question.")
